...
# import tf_transformations
# import tf2_ros
# from tf2_ros.static_transform_broadcaster import StaticTransformBroadcaster # Added import
# import json
# import time
# import math
# import pprint
...
#         self.declare_parameter('frame_odom', 'odom')
#         self.declare_parameter('frame_base', 'base_link')
#         self.declare_parameter('frame_imu', 'imu_link') # New parameter for IMU frame
#         self.declare_parameter('publish_marker', True)
#         self.declare_parameter('marker_scale', [0.2, 0.2, 0.08])
...
#         # --- STATIC TRANSFORM FOR IMU (-13cm x, -7cm y) ---
#         self.tf_static_broadcaster = StaticTransformBroadcaster(self)
#         self._publish_imu_static_tf()
...
#     def _publish_imu_static_tf(self):
#         t = TransformStamped()
#         t.header.stamp = self.get_clock().now().to_msg()
#         t.header.frame_id = self.frame_base
#         t.child_frame_id = self.frame_imu
        
#         # Fixed offset: x = -13cm, y = -7cm
#         t.transform.translation.x = -0.07
#         t.transform.translation.y = 0.13
#         t.transform.translation.z = 0.0
        
#         # Identity rotation (assuming aligned with base)
...
#             # --- MODIFIED: Use the fixed IMU frame ---
